...
class PageDetailsController extends Controller
{
  use FileUploadTrait;
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request, PageDetail $post)
    {
    ...
    {
      $post = PageDetail::where('id_page', $id)->first();
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(PageDetail $post)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, PageDetail $post)
    {
      $this->validate($request, array(
        "name"=>'required',
    ...
    {
        $post = PageDetail::where('id_page', $id)->delete();
