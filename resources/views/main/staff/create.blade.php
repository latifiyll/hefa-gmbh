        ...
        <div class="col-lg-10">
          <div class="card">
            <div class="card-header">
              <strong>Create</strong> Staff Member
            </div>
            <div class="card-body card-block">
              <form method="POST" action="{{ url('/staff') }}" aria-label="{{ __('Register') }}">
                  @csrf
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-6">
                          <input id="p_code" type="text" class="form-control{{ $errors->has('p_code') ? ' is-invalid' : '' }}" name="p_code" value="{{ old('p_code') }}" required autofocus>
                  ...
                  <div class="form-control{{ $errors->has('role') ? ' is-invalid' : '' }}" >
                    ...
                    <input type="radio" name="role" value="2">manager</input>
                    <input type="radio" name="role" value="3">controller</input>
